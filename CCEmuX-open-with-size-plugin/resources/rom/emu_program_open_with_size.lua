...
if ccemux then
    local function help()
        ...
        print("emu open [id, width, height] - open another computer")
    ...
    if #args == 0 then
        ...
        elseif args[1] == "open" then
            print(ccemux.openEmuWithSize,args[2],args[3],args[4])
            print("Opened computer ID " .. (ccemux.openEmuWithSize and ccemux.openEmuWithSize(tonumber(args[2]),tonumber(args[3]),tonumber(args[4])) or ccemux.openEmu(tonumber(args[2]))))
